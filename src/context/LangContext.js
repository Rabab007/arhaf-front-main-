...
export const translations = {
  ar: {
    appName: 'أرهف', langToggle: 'English', dir: 'rtl', font: "'IBM Plex Sans Arabic', 'Cairo', sans-serif",
    ...
    resultsIntro: 'إليك التقييم المعتمد على AI والمستخرج من تسجيل البكاء المرفوع.',
    ...
    normalTd: 'طبيعي / TD',
    asdIndicator: 'مؤشر ASD',
    predictionLabel: 'نتيجة النموذج',
    confidenceLabel: 'نسبة الثقة',
    childLabel: 'الطفل',
    modelConfidenceTitle: 'ثقة النموذج',
    featureSnapshotTitle: 'ملخص نشاط الخصائص',
    analyzedFeaturesTitle: 'الخصائص التي تم تحليلها',
    featuresSummary: 'قام النموذج بتحليل خصائص الصوت المستخرجة من تسجيل البكاء، بما في ذلك تمثيلات MFCC وميزات delta وdelta-delta وخصائص spectral-energy.',
    featureMfcc: 'MFCC Features',
    featureDelta: 'Delta / Delta-Delta',
    featureRms: 'RMS Energy',
    featureZcr: 'Zero Crossing Rate',
    featureCentroid: 'Spectral Centroid',
    featureRolloff: 'Spectral Rolloff',
    shareCopied: 'تم نسخ النتيجة بنجاح',
    shareCancelled: 'تم إلغاء المشاركة',
    reportTitle: 'تقرير تحليل بكاء أرهف',
    reportChild: 'الطفل',
    reportPrediction: 'النتيجة',
    reportConfidence: 'نسبة الثقة',
    reportSummary: 'الملخص',
    reportRecommendation: 'التوصية',
  ...
  en: {
    appName: 'Arhaf', langToggle: 'العربية', dir: 'ltr', font: "'Manrope', 'Inter', 'Segoe UI', sans-serif",
    ...
    resultsIntro: 'Here is the AI-based assessment generated from the uploaded cry recording.',
    ...
    normalTd: 'Normal / TD',
    asdIndicator: 'ASD Indicator',
    predictionLabel: 'Prediction',
    confidenceLabel: 'Confidence',
    childLabel: 'Child',
    modelConfidenceTitle: 'Model Confidence',
    featureSnapshotTitle: 'Feature Activity Snapshot',
    analyzedFeaturesTitle: 'Analyzed Features',
    featuresSummary: 'The model analyzed acoustic features extracted from the cry recording, including MFCC-based representations, delta features, and spectral-energy related characteristics.',
    featureMfcc: 'MFCC Features',
    featureDelta: 'Delta / Delta-Delta',
    featureRms: 'RMS Energy',
    featureZcr: 'Zero Crossing Rate',
    featureCentroid: 'Spectral Centroid',
    featureRolloff: 'Spectral Rolloff',
    shareCopied: 'Result copied successfully',
    shareCancelled: 'Sharing cancelled',
    reportTitle: 'Arhaf Cry Analysis Report',
    reportChild: 'Child',
